...
class MQTTClient:
	...
	async def async_init( self ) -> None:
		...
		topics = {
			...
			"Zbeacon_stat": {
				"topic": "stat/#",
				"msg_callback": self.__on_Zbeacon_stat,
				"qos": 0,
				"event_loop_safe": True
			},
			"Zbeacon_tele": {
				"topic": "tele/#",
				"msg_callback": self.__on_Zbeacon_tele,
				"qos": 0,
				"event_loop_safe": True
			}
		}
	...
	def remove_device( self, uuid ):
		...
		self.hass.async_create_task( self.async_publish( f"Zbeacon/discovery/{uuid}/config", None, None, True ) )
	...
	@callback
	def __on_Zbeacon_stat( self, msg: mqtt.ReceivePayloadType ) -> None:
	...
	@callback
	def __on_Zbeacon_tele( self, msg: mqtt.ReceivePayloadType ) -> None:
